...
<table width="98%" style="width:100%;">
  ...
  <tr>
    ...
    <td style="text-align: center;">
        ...
        <p>Your Scheduled Date : {{$data['scheduled_date']}}</p>
...
<p style="text-align: justify;">Based on our records, it shows that you have comitted servel violations. This is to inform you that you have an upcoming counselling session at TUP-Taguig Guidance Office.</p>
